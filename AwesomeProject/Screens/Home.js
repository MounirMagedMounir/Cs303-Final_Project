  ...
  return (
    <View style={styles.container}>
      <ScrollView>
        ...
        <SafeAreaView>
          <View style={styles.scrollContainer1}>
            <TouchableOpacity style={{ marginRight: -340}}>
              <Text style={styles.scrollHead}>men</Text>
            </TouchableOpacity>
            <ScrollView
              horizontal={true}
              pagingEnabled
        ...
        <SafeAreaView>
          <View style={styles.scrollContainer1}>
            <TouchableOpacity style={{ marginRight: -310}}>
              <Text style={styles.scrollHead}>wemen</Text>
            </TouchableOpacity>
            <ScrollView
              horizontal={true}
              pagingEnabled
        ...
        <SafeAreaView>
          <View style={styles.scrollContainer1}>
            <TouchableOpacity style={{ marginRight: -340}}>
              <Text style={styles.scrollHead}>east</Text>
            </TouchableOpacity>
            <ScrollView
              horizontal={true}
              pagingEnabled
