    ...
    <ScrollView>
      <ImageBackground source={b} style={styles.backgroundImage}>
        <View style={styles.inputsContainer}>
          <Text style={{ fontSize: 40, marginTop: 80, fontWeight: "bold" }}>
            Hello Again!
          </Text>
          ...
          <View>
            <Ionicons
              ...
              size={17}
              color="#666"
              style={{ marginTop: -59, marginLeft: -130 }}
            />
            <Ionicons
              name="mail-outline"
              size={17}
              color="#666"
              style={{ marginTop: -99, marginLeft: -130 }}
            />
          </View>
          <Ionicons
            name={Icon}
            size={19}
            color="#666"
            style={{ marginTop: -57, marginBottom: 40, marginRight: -260 }}
            onPress={ChangeIcon}
          ></Ionicons>
